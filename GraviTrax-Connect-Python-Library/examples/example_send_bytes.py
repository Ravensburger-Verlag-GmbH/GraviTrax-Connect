"""Gravitrax Example Script:Sending Bytes With this script it´s possible to
send bytes of data to the Bridge. In order for the Bridge to recognize the data
as a signal the following format needs to be used. Byte 0 = 19 -> header Byte 1
= a valid stonetype -> stone.
