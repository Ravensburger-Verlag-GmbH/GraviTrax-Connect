...
STATUS_CANNON_LOW_SHOT = 208
STATUS_SILVER_COLOR_DETECTOR = 209
STATUS_GOLD_COLOR_DETECTOR = 210
...
DICT_STATUS = {
    ...
    "SOUND": STATUS_SOUND,
    "LEVER": STATUS_LEVER,
    "CANNON": STATUS_CANNON,
    "UNLOCK": STATUS_UNLOCK,
    "LOCK": STATUS_LOCK,
    "STARTER_PRESS": STATUS_STARTER_PRESS,
    "CANNON_LOW_SHOT": STATUS_CANNON_LOW_SHOT,
    "SILVER_COLOR_DETECTOR": STATUS_SILVER_COLOR_DETECTOR,
    "GOLD_COLOR_DETECTOR": STATUS_GOLD_COLOR_DETECTOR,
}
...
DICT_VAL_STATUS = {
    ...
    STATUS_CANNON_LOW_SHOT: "CANNON_LOW_SHOT",
    STATUS_SILVER_COLOR_DETECTOR:"SILVER_COLOR_DETECTOR",
    STATUS_GOLD_COLOR_DETECTOR:"GOLD_COLOR_DETECTOR",
}
